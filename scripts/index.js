...
const buttonCloseProfile = popup.querySelector('.popup__buttonClose_type_profile');
...
const popupAddCardButtonClose = document.querySelector ('.popup__buttonClose_type_add-card')
// Находим форму в DOM
const formElement = document.querySelector ('.popup__container_type_profile'); // Воспользуйтесь методом querySelector()
// Находим поля формы в DOM
const nameInput = formElement.querySelector ('.popup__inputName_type_profile');  // Воспользуйтесь инструментом .querySelector()
const jobInput =  formElement.querySelector ('.popup__inputJob_type_profile');  // Воспользуйтесь инструментом .querySelector()
...
const inputTitleAddCardForm = document.querySelector('.popup__inputTitle_type_add-card');
const inputImageAddCardForm = document.querySelector('.popup__inputImage_type_add-card');
